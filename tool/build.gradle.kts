...
android {
    ...
    signingConfigs {
        ...
        create("sideload") {
            val keystore = System.getenv("LIGHTNONOGRAM_KEYSTORE_FILE")
            if (!keystore.isNullOrBlank()) {
                storeFile = file(keystore)
                storePassword = System.getenv("LIGHTNONOGRAM_KEYSTORE_PASSWORD")
                keyAlias = System.getenv("LIGHTNONOGRAM_KEY_ALIAS") ?: "lightnonogram"
                keyPassword = System.getenv("LIGHTNONOGRAM_KEY_PASSWORD")
                    ?: System.getenv("LIGHTNONOGRAM_KEYSTORE_PASSWORD")
    ...
    val hasSideloadKey = !System.getenv("LIGHTNONOGRAM_KEYSTORE_FILE").isNullOrBlank()
